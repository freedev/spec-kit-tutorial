...
See [docs/what-is-spec-kit.md](docs/what-is-spec-kit.md) for an overview of Spec-Driven Development.

See [docs/when-to-use-sdd.md](docs/when-to-use-sdd.md) for when SDD is (and isn't) the right tool.
