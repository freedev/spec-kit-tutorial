...
## Building a Number Guessing Game in Java with [GitHub Spec Kit](https://github.com/github/spec-kit)
...
> or always use a specific Java version, this is where you declare that.
...
- [ ] T003: Create HintGenerator class with generateHint(secret, guess)
...
- [ ] T006: Create GameSession class tracking attempts and game state
- [ ] T007: Write unit tests for GameSession

## User Story 4: Input validation
- [ ] T008: Create InputValidator class
- [ ] T009: Write unit tests for invalid input cases

## User Story 5: Game loop
- [ ] T010: Implement main game loop in App.java
...
You did not write a single line of Java manually. Instead, you:
